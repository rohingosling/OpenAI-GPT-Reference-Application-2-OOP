...
**Version:** 2.0 (OOP version)

General purpose OpenAI GPT API reference application, demonstrating the basic layout and features of an LLM-based ChatGPT with conversation history, user commands, and saving of chat log file.
